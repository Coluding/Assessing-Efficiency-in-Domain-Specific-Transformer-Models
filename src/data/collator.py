...
class DataCollatorForDocumentElectra:
    """
    Data collator used for document electra. This function is called by the dataloader to create a batch.
    It is called right qfter the dataloader retrieves a batch from the dataset in the form of a list of dictionaries.
    It can be seen as an intermediate step between the dataset and the dataloader.
    Workflow:
    - The dataloader retrieves a batch from the dataset in the form of a list of dictionaries
    - The dataloader calls this function to create a batch
    - This function returns a dictionary of tensors
    - The dataloader returns this dictionary of tensors
