...
from src.model.modelling_electra import DocumentElectraModelForDownstream
...
def create_optimizers(lr,
    ...
    if hasattr(model.document_electra.word_encoder, "transformer"):
        ...
        raise NotImplementedError("No transformer encoder found in word_encoder")
    ...
    if hasattr(model.document_electra, "sentence_encoder"):
        if hasattr(model.document_electra.sentence_encoder, "transformer"):
            ...
            raise NotImplementedError("No sentence encoder found in document_electra")
    ...
    # Implementation uses smaller learning rate for the later layers
    ...
    # param groups assigns individual dictionary for individual torch module:
